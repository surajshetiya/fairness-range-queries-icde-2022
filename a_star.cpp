    ...
    */
    ...
    while(!H.empty()) {
        ...
        if(++dummyCounter % 50000 == 0) {
            cout << "Disparity : " << topItem.intersection << ":" << topItem.union_ << " ; Distance approx : " << topItem.distanceApprox() << endl << "Skyline duration : " << skylineDuration.count() << "microsectonds" << endl;
        }
        H.pop();
